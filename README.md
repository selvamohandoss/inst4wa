...
## Specific Steps for Deploying a HelloWorld Solution Consisting of a WebRole
...
3. Use the following command to deploy the solution to Windows Azure: 
    ...
    Inst4WA.exe -XmlConfigPath "TestCases\StaticTests-Azure\HelloWorldWebRoleWR.xml" -DomainName “<your domain name>” -Subscription “<your subscription name>”

## Specific Steps for Deploying a HelloWorld Solution Consisting of a WorkerRole
...
3. Use the following command to deploy the solution to Windows Azure: 
    ...
    Inst4WA.exe -XmlConfigPath "TestCases\StaticTests-Azure\HelloWorldWorkerRoleWR.xml" –DomainName “<your domain name>” -Subscription “<your subscription name>”

## Steps for Deploying CouchDb Solution to Windows Azure

Please refer to the ReadMe at the https://github.com/MSOpenTech/Windows-Azure-CouchDB.

## Steps for Deploying Solr Solution to Windows Azure
...
- StepSequences.csv à CSV contains the list of cmdlets that should be invoked as part of test. 

- CommandParams.csv à CSV contains the list of parameters that should be passed to the cmdlets listed inside stepsequences.csv.

- ParamValues.csv à CSV contains all possible combinations of parameters with which a cmdlet should be invoked.
